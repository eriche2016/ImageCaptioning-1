...
function M.train(model, opt, batches, val_batches, optim_state, dataloader)
    ...
    local optim_state, conv5_optim_state = {}, {}, {}

    local vgg19_input_conv5_model
    ...
    local att_seq, fc7_images, input_text, output_text, noun_list, fc7_google_images, jpg
    ...
    for epoch = 1, opt.nEpochs do
        ...
        for i = 1, #batches do
            att_seq, fc7_images, input_text, output_text, noun_list, fc7_google_images, jpg = dataloader:gen_train_data(batches[index[i]])
            feval(true)
            ...
            if i == 1 or i % opt.eval_period == 0 then
                ...
                while j1 <= #dataloader.val_set do
                    ...
                    att_seq, fc7_images, fc7_google_images, jpg = dataloader:gen_test_data(j1, j2)
