...
function M.parse(arg)    
    ...
    cmd:option('-save_file_name', 'reason.copy.vgg16.model', 'file name for saving model')
    ...
    cmd:option('-load_file_name', 'copy.server.init12000.vgg.all.val.8.w10.noun.model')
