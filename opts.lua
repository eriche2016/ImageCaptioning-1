...
function M.parse(arg)    
    ...
    cmd:option('-LR', 1e-3, 'Initial learning rate') -- 0.01
    ...
    cmd:option('-save_file_name', 'copy.server.6000.1e-3.vgg.all.val.8.w10.noun.model', 'file name for saving model')
    cmd:option('-save_conv5_name', 'copy.server.6000.1e-3.fine.vgg.conv5.model')
    cmd:option('-save_fc7_name', 'copy.server.6000.1e02.fine.vgg.fc7.model')
