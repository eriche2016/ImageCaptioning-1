...
function M.parse(arg)    
    ...
    cmd:option('-save_file_name', 'conv519.seed13.backfixed.reason.copy.vgg16.model', 'file name for saving model')
    ...
    cmd:option('-load_file_name', 'gen_drop0.2.conv519.seed13.backfixed.reason.copy.vgg16.model')
