...
function M.parse(arg)    
    ...
    cmd:option('-LR', 0.0, 'Initial learning rate') -- 1e-2
    cmd:option('-cnn_LR', 4e-6, 'Learning rate for cnn') -- 1e-2
    ...
    cmd:option('-save_file_name', 'fine04e-6.conv519.seed13.backfixed.reason.copy.vgg16.model', 'file name for saving model')
