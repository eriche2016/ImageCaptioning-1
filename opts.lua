...
function M.parse(arg)    
    ...
    cmd:option('-test_feat', 'val2014_features_vgg_vd19_conv5', 'Path to pre-extracted test image feature')
    ...
    cmd:option('-train_fc7', 'val2014_features_googlenet', 'Path to pre-extracted training fully connected 7')
