...
function M.parse(arg)    
    ...
    cmd:option('-save_file_name', 'drop35fc7.4e-5finefc7.conv519.seed13.backfixed.reason.copy.vgg16.model', 'file name for saving model')
    ...
    cmd:option('-load_file_name', 'fc7drop.conv519.seed13.backfixed.reason.copy.vgg16.model')
