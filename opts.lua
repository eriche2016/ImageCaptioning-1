...
function M.parse(arg)    
    ...
    cmd:option('-val_feat', 'val2014_features_vgg_vd19_conv5_2nd', 'Path to pre-extracted validation image feature')
    cmd:option('-test_feat', 'val2014_features_vgg_vd19_conv5_2nd', 'Path to pre-extracted test image feature')
    ...
    cmd:option('-val_fc7', 'val2014_features_googlenet_2nd', 'Path to pre-extracted validation fully connected 7')
    cmd:option('-test_fc7', 'val2014_features_googlenet_2nd', 'Path to pre-extracted test fully connected 7')
