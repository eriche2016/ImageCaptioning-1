...
function M.parse(arg)    
    ...
    cmd:option('-train_fc7', 'train2014_vgg_vd16_fc7', 'Path to pre-extracted training fully connected 7')
    cmd:option('-val_fc7', 'val2014_vgg_vd16_fc7', 'Path to pre-extracted validation fully connected 7')
    cmd:option('-test_fc7', 'test2014_vgg_vd16_fc7', 'Path to pre-extracted test fully connected 7')
    ...
    cmd:option('-LR', 1e-7, 'Initial learning rate') -- 0.01, 4e-5 for finetune
    cmd:option('-cnn_LR', 1e-6, 'Learning rate for cnn') -- 4e-5 for finetune
    ...
    cmd:option('-save_file_name', 'fine1e-71e-6.conv519.seed13.backfixed.reason.copy.vgg16.model', 'file name for saving model')
