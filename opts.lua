...
function M.parse(arg)    
    ...
    cmd:option('-save_file_name', 'copy.server.ada.fine.vgg.all.val.8.w10.noun.model', 'file name for saving model')
    cmd:option('-save_conv5_name', 'copy.server.ada.fine.vgg.conv5.model')
    cmd:option('-save_fc7_name', 'copy.server.ada.fine.vgg.fc7.model')
