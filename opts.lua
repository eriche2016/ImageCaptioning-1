...
function M.parse(arg)    
    ...
    cmd:option('-save_file_name', '6000.1e-4.fine.model', 'file name for saving model')
    cmd:option('-save_conv5_name', '6000.1e-4.fine.conv5.model')
    cmd:option('-save_fc7_name', '6000.1e-4.fine.fc7.model')
