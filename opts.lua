...
function M.parse(arg)    
    ...
    cmd:option('-save_file_name', 'copy.server.6000.1e-2.vgg.all.val.8.w10.noun.model', 'file name for saving model')
    cmd:option('-save_conv5_name', 'copy.server.6000.1e-2.fine.vgg.conv5.model')
