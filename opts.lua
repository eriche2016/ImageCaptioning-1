...
function M.parse(arg)    
    ...
    cmd:option('-train_inst', 'annotations/instances_train2014.json', 'Path to training image instances file')
    cmd:option('-val_inst', 'annotations/instances_val2014.json', 'Path to validation image instances file')
