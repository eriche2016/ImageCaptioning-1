...
function M.parse(arg)    
    ...
    cmd:option('-LR', 4e-4, 'Initial learning rate') -- 0.01
    cmd:option('-cnn_LR', 1e-5, 'Learning rate for cnn')
    ...
    cmd:option('-save_file_name', 'finefc7.conv519.seed13.backfixed.reason.copy.vgg16.model', 'file name for saving model')
