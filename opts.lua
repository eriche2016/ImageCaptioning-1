...
function M.parse(arg)    
    ...
    cmd:option('-save_file_name', 'r0.1g0.1.offdev.conv519.seed13.backfixed.reason.copy.vgg16.model', 'file name for saving model')
    ...
    cmd:option('-load_file_name', 'fienconv01e-7.offdev.conv519.seed13.backfixed.reason.copy.vgg16.model')
