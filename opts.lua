...
function M.parse(arg)    
    ...
    cmd:option('-cnn_LR', 1e-7, 'Learning rate for cnn') -- 1e-2
    ...
    cmd:option('-save_file_name', 'gen_drop0.1.offdev.conv519.seed13.backfixed.reason.copy.vgg16.model', 'file name for saving model')
